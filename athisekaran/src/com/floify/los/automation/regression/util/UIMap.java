package com.floify.los.automation.regression.util;
...
public class UIMap {
	...
	public By getLocator2(String locator) throws Exception {
		// Read value using the logical name as Key
		// Split the value which contains locator type and locator value
		String locatorType = locator.split(":")[0];
		String locatorValue = locator.split(":")[1];
	...
	public String getPropertyValue(String ElementName) throws Exception {
		// Read value using the logical name as Key
